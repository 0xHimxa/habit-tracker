...
router.get('/:habitId', (0, validation_1.validateRequest)({ params: { habitId: zod_1.z.string().min(1) }, query: completionValidators_1.getCompletionsSchema }), completions_1.getCompletions);
