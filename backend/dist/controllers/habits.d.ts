...
export declare const manualBreakdown: (req: AuthRequest, res: Response) => Promise<void>;
export declare const getGoalCompletionCounts: (req: AuthRequest, res: Response) => Promise<void>;
